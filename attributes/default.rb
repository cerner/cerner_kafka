...
default["kafka"]["env_vars"]["KAFKA_JVM_PERFORMANCE_OPTS"] = "\"-XX:PermSize=48m -XX:MaxPermSize=48m -XX:+UseG1GC -XX:MaxGCPauseMillis=5 -XX:InitiatingHeapOccupancyPercent=35\""
...
default["kafka"]["log4j.properties"]["log4j.appender.kafkaAppender.MaxFileSize"] = "10KB"
...
default["kafka"]["log4j.properties"]["log4j.appender.stateChangeAppender.MaxFileSize"] = "10KB"
...
default["kafka"]["log4j.properties"]["log4j.appender.requestAppender.MaxFileSize"] = "10KB"
...
default["kafka"]["log4j.properties"]["log4j.appender.controllerAppender.MaxFileSize"] = "10KB"
